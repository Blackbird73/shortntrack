<?php 
    ...
    echo "<h1>CREATION DE LIEN COURT / REDIRECTION </h1><hr><br>";

    if( !empty($_GET['lien']) ){ //and isset($_SESSION['prevent_repeat']) 
 
        $lien_long  = urlencode($_GET['lien']); // lien rçu par formulaire
        ...
        unset($_SESSION['prevent_repeat']); // Pour éviter une répétition de l'opération
 
    } else {

        echo "Requête non valable"; // Aucune données valable n'est passée par l'URL : ID et lien 
